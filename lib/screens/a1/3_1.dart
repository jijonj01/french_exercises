...
/// Main widget for the French Articles Game
class A1Seven extends StatefulWidget {
  final String imageUrl;
  const A1Seven({Key? key, required this.imageUrl}) : super(key: key);

  @override
  _A1SevenState createState() => _A1SevenState();
}

class _A1SevenState extends State<A1Seven> {
  // ====== Section: Articles Indéfinis ======
  final List<WordItem> _initialWordsIndefini = [
    WordItem(text: 'livre', genre: 'masculin', isPlural: false),
    WordItem(text: 'chaise', genre: 'féminin', isPlural: false),
    WordItem(text: 'pommes', genre: 'féminin', isPlural: true),
    WordItem(text: 'gâteaux', genre: 'masculin', isPlural: true),
  ];
      ...
      onAccept: (word) {
        ...
        if (correct) {
          setState(() {
            ...
            if (isIndefiniSection &&
                totalPlaced == _initialWordsIndefini.length) {
            ...
            if (!isIndefiniSection &&
                totalPlacedDef == _initialWordsDefini.length) {
            ...
            SafeArea(
              child: Column(
                children: [
                  ...
                  // Page Title
                  const Text(
                    'Jeu pour Apprendre les Articles Français',
                    style: TextStyle(
                      fontSize: 24,
                      fontWeight: FontWeight.bold,
                  ...
                  _buildSection(
                    ...
                    messageText:
                        'Bravo ! Tous les mots ont été classés correctement pour les articles indéfinis !',
                  ),
                  ...
                  _buildSection(
                    ...
                    messageText:
                        'Félicitations ! Vous avez correctement classé tous les mots pour les articles définis !',
                  ),
                ],
              ),
            ),
